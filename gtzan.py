...
Root='/content/drive/MyDrive/gtzan_music'
os.chdir(Root)

audio_data = '/content/drive/MyDrive/gtzan_music/Data/genres_original/rock/rock.00000.wav'
...
df1 = pd.read_csv('/content/drive/MyDrive/gtzan_music/Data/features_3_sec.csv')
df1.head()
